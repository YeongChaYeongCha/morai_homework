...
class IMGParser:
    def __init__(self):
        ...
        #first course
        # self.lower_wlane = np.array([12,120,100])
        # self.upper_wlane = np.array([30,255,255])
        # self.lower_ylane = np.array([80,85,100])
        # self.upper_ylane = np.array([130,255,255])

        #second course
        self.lower_wlane = np.array([0,0,200])
        self.upper_wlane = np.array([30,60,255])
        self.lower_ylane = np.array([12,120,100])
        self.upper_ylane = np.array([30,255,255])

        #third course
        # self.lower_wlane = np.array([0,0,40])
        # self.upper_wlane = np.array([180,70,180])
        # self.lower_ylane = np.array([20,20,30])
        # self.upper_ylane = np.array([50,255,255])

        self.crop_pts = np.array([[[30,185],[140,125],[180,125],[290,185]]])
